...
<title>introducere tipuri de evaluare</title>
</head>
<body>
<%!
	...
	public void getRDF(HttpServletRequest request,javax.servlet.jsp.JspWriter out) throws java.io.IOException
	{
		String btnPush1=request.getParameter("btn1");
 		...
 		if(btnPush1!=null){
			...
			out.print(RDFConstruction.createEvaluationTypeRDF(titlu));
 		}
...
<form action="introducereEvalTypeRDF.jsp" method="get" style="height: 187px">

<table style="height: 55px; width: 331px">
<tr>
<td>
<label>titlu evaluare</label></td>
